...
{
    protected $signature = 'demo:create {--users=10} {--carreras=3} {--semestres=8}';
    protected $description = 'Crear datos de demostración para el sistema académico';
    ...
    public function handle()
    {
        ...
        try {
            ...
            // Crear evaluaciones y notas
            $this->createEvaluacionesYNotas($materias, $semestres, $estudiantes);
            ...
            $this->info("   - Carreras: " . carrera::count());
            $this->info("   - Semestres: " . semestre::count());
            $this->info("   - Materias: " . materia::count());
            $this->info("   - Profesores: " . Profesor::count());
            $this->info("   - Estudiantes: " . estudiante::count());
            $this->info("   - Evaluaciones: " . Evaluacion::count());
    ...
    private function createAdminUsers()
    {
        ...
        $this->info('✅ Usuario admin creado: admin@test.com / password');
    }

    private function createCarreras()
    {
        $this->info('Creando carreras...');
    ...
    {
        $this->info('Asignando relaciones...');
    ...
    private function createEvaluacionesYNotas($materias, $semestres, $estudiantes)
    {
        $this->info('Creando evaluaciones y notas...');
